...
/*---Phân biệt dấu---*/
{
    $(document).ready(function () {
        $('.form-searchbox').submit(function (event) {
            ...
            // Chuẩn hóa và chuyển đổi từ khóa tìm kiếm sang chữ thường
            var searchTerm = removeAccents($('#search-landscape').val().toLowerCase().trim()); 
            $('.product-item').each(function () {
                // Chuẩn hóa và chuyển đổi tiêu đề sản phẩm sang chữ thường
                var productTitle = removeAccents($(this).find('.item-title a').text().toLowerCase().trim()); 
    ...
    // Hàm loại bỏ các khoảng trắng và chuẩn hóa ký tự
...
/*---Hàm tìm kiếm khi responsive trang sang mobile---*/
{
    $(document).ready(function () {
...
/*---Hàm sắp xếp theo giá, số lượt bán---*/
{
    ...
    function sortBySalesHighToLow(a, b) {
        // Lấy số lượt bán từ phần tử con có class là data-sales và chuyển thành số nguyên
        var salesA = parseInt(a.querySelector(".data-sales").innerText); 
        var salesB = parseInt(b.querySelector(".data-sales").innerText);
    ...
    document.getElementById("sort-by").addEventListener("change", function () {
        ...
        if (sortBy === "no-sort") {
            // Nếu giá trị được chọn là "no-sort" thì gán lại danh sách sản phẩm ban đầu vào productList
...
/*---Hàm lọc sản phẩm thuộc hãng sản xuất hoặc trạng thái hoặc cấu hình theo mức giá---*/
{
    ...
    const filterProducts = () => {
        ...
        // Lấy giá trị được nhập vào từ ô giá
        ...
        ratingButtons.forEach(function (button) {
            button.addEventListener('click', function () {                
                ...
                productItems.forEach(function (item) {
                    ...
                    if (stars) {
                        // Lấy độ rộng của sao từ style width
